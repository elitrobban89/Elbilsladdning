...
public class CarDatabase {
    ...
    public static final List<CarSpec> CARS = List.of(
        ...
        new CarSpec("Volkswagen ID.5",                 11.0,  135.0, List.of("type2","ccs"),           77.0),
        new CarSpec("Volkswagen ID.7",                 11.0,  200.0, List.of("type2","ccs"),           82.0),

        // BMW
        new CarSpec("BMW i4 eDrive40",                 11.0,  210.0, List.of("type2","ccs"),           84.0),
        new CarSpec("BMW i5 eDrive40",                 11.0,  205.0, List.of("type2","ccs"),           81.0),
        new CarSpec("BMW iX xDrive50",                 11.0,  200.0, List.of("type2","ccs"),          105.0),
        new CarSpec("BMW iX3",                         11.0,  150.0, List.of("type2","ccs"),           74.0),

        // Audi
        new CarSpec("Audi Q4 e-tron",                  11.0,  135.0, List.of("type2","ccs"),           77.0),
        ...
        new CarSpec("Polestar 3",                      11.0,  250.0, List.of("type2","ccs"),          111.0),

        // Mercedes
        new CarSpec("Mercedes EQA 250",                11.0,  100.0, List.of("type2","ccs"),           67.0),
        new CarSpec("Mercedes EQC",                    11.0,  110.0, List.of("type2","ccs"),           80.0),
        new CarSpec("Mercedes EQE 350",                11.0,  170.0, List.of("type2","ccs"),           91.0),

        // Ford
        new CarSpec("Ford Mustang Mach-E",             11.0,  150.0, List.of("type2","ccs"),           91.0),
        ...
        // MG
        new CarSpec("MG4 Long Range",                  11.0,  150.0, List.of("type2","ccs"),           77.0),

        // Porsche
        new CarSpec("Porsche Taycan",                  11.0,  270.0, List.of("type2","ccs"),           93.0),

        // Toyota / Subaru
        new CarSpec("Toyota bZ4X",                     11.0,  150.0, List.of("type2","ccs"),           71.4),

        // Cupra / Renault
        new CarSpec("Cupra Born",                      11.0,  170.0, List.of("type2","ccs"),           77.0),
        new CarSpec("Renault Megane E-Tech",            22.0,  130.0, List.of("type2","ccs"),           60.0),
        new CarSpec("Renault Zoe",                     22.0,   50.0, List.of("type2","ccs"),           50.0),

        // Nissan
        new CarSpec("Nissan Ariya",                    22.0,  130.0, List.of("type2","ccs"),           87.0),
        new CarSpec("Nissan Leaf (50 kWh)",             6.6,   50.0, List.of("type2","chademo"),        40.0),

        // Övrigt
        new CarSpec("Fiat 500e",                       11.0,   85.0, List.of("type2","ccs"),           42.0),
