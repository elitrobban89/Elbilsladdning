...
106 backendtester i fyra lager — ren logik, repository mot H2, HTTP-felvägar och controller-lagret (MockMvc, tjänsterna mockas). **Tabellen summerar till totalen**, så en klass som glöms bort syns som ett glapp:
