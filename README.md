...
| `ChargingControllerTest` (12) | Billistans form, bilindexvalidering 400, prisberikning i stationsflödet, chattens rate limit → 429. **Källorna fångas var för sig** (2026-08-30): OCM och NOBIL låg i ett gemensamt `try`, så ett NOBIL-fel — som bara bidrar med antalet kontakter — tömde hela stationslistan och gav noll stationer med HTTP 200, alltså ett svar som inte gick att skilja från "inga laddare i närheten". Uppmätt i drift samma dag: identiska anrop gav växelvis 5 och 0 stationer. Båda grenarna loggar nu orsaken; den tysta catch-grenen var det som gjorde felet osynligt i Render-loggen |
